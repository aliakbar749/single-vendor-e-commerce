                ...
                <table class="table table-borderless">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{__('Required Versio')}}n</th>
                ...
                <table class="table table-borderless">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{__('Current Setting')}}s</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><strong>{{__('On')}}</strong></td>
                        <td><span class="status {{ !extension_loaded('ctype') ? 'error' : '' }}">{{ !extension_loaded('ctype') ? __(__('Error')) : __('Ok') }}</span></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><strong>{{__(__('On'))}}</strong></td>
                        <td><span class="status {{ !extension_loaded('json') ? 'error' : '' }}">{{ !extension_loaded('json') ? __('Error') : __('Ok') }}</span></td>
                      </tr>
                      {{-- <tr>
                        <td>date.timezone</td>
                        <td><strong>{{ !extension_loaded('date.timezone') ? __('Off') : __(__('On')) }}</strong></td>
                        <td><strong>On</strong></td>
                        <td><span class="status {{ !extension_loaded('date.timezone') ? 'error' : '' }}">{{ !extension_loaded('date.timezone') ? __('Error') : __('Ok') }}</span></td>
                      </tr> --}}
                    </tbody>
                </table>
            </div>
