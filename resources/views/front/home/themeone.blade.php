                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" >
                            <div class="image-container">
                                @if ($data->image== NULL)
                                <video  controls onclick="openModal('{{ $data->id }}', 'video')">
                                    <source src="{{asset('uploaded_files/videos/' .$data->video)}}" type="video/mp4">
                                    
                                    
                                </video>
                                @else
                                <img  onclick="openModal('{{ $data->id }}', 'image')"  src="{{asset('uploaded_files/story/' .$data->image)}}" alt="Image">
                                {{-- <a  >
                                    <img  class="lightbox img-mask "  src="{{asset('uploaded_files/story/' .$data->image)}}" data-fancybox="gallery" data-caption="" alt="">
                                </a> --}}
                                @endif
                               
                                <div class="image-text">{{$data->title}}</div>
                                <button class="image-button btn btn-sm">Button</button>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <img src="https://img.freepik.com/premium-photo/alpine-cow-field_119101-251.jpg?size=626&ext=jpg&ga=GA1.2.47272926.1684212308&semt=ais" alt="Story 2">
                        </div>
                        <div class="swiper-slide">
                            <img src="https://img.freepik.com/premium-photo/alpine-cow-field_119101-251.jpg?size=626&ext=jpg&ga=GA1.2.47272926.1684212308&semt=ais" alt="Story 3">
                        </div>
                        <div class="swiper-slide">
                            <img src="https://img.freepik.com/premium-photo/alpine-cow-field_119101-251.jpg?size=626&ext=jpg&ga=GA1.2.47272926.1684212308&semt=ais" alt="Story 3">
                        </div>
            ...
            {{-- <div class="swiper-container">
                <div class="row mt-5">
                    ...
                    <div class="col-lg-2 mt-4">
                        <a class="lightbox img-mask " href="{{ asset('uploaded_files/story/' . $data->image) }}" data-fancybox="gallery" data-caption="">
                            @if ($data->video==1)
                            <video src="{{ asset('uploaded_files/story/' . $data->image) }}"></video>
                            @else
                                
                            @endif
                            <img src="{{ asset('uploaded_files/story/' . $data->image) }}" alt="">
                        </a>
                    </div>
